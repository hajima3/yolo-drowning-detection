...
console.log('🐟 Loading Enhanced Koi Fish System...')

const pc = butterfliesBackground({
  el: document.getElementById('app'),
  eventsEl: document.body,
  gpgpuSize: 18, // Same as working butterflies
  background: 0x0066AA, // Deep ocean blue
  material: 'phong',
  lights: [
  ...
  // Use the same working butterfly texture first, then we'll modify
  texture: 'https://assets.codepen.io/33787/butterflies.png',
  textureCount: 4,
  wingsScale: [2, 2, 2], // Same as working butterflies
  ...
  attractionRadius1: 100, // Same as working butterflies
  attractionRadius2: 150,
  maxVelocity: 0.1
})

console.log('🐟 Enhanced Koi Fish System loaded successfully!', pc)
